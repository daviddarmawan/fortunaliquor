...
@section('content_header')
    <h1 class="m-0 text-dark">Laporan Piutang Pelanggan</h1>
@stop
@section('content')
    <div class="row">
        <div class="col-12">
                    ...
                    <table class="table table-hover table-bordered table-stripped" id="example2">
                        ...
                        @foreach($order as $key => $order)
                            <tr>
                                ...
                                <td><a href="{{route('pembayaran.edit', $order)}}" class="btn btn-primary"><i class="fa fa-credit-card" aria-hidden="true"></i> Bayar</a></td>                         
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
