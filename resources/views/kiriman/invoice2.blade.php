  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company" class="clearfix">
        ...
        <div>+62 856-4083-6111</div>
        <div><a href="mailto:daviddarmwan15@gmail.com">firdayantofrisky@gmail.com</a></div>
      </div>
      <div id="project">
    ...
    <main>
      ...
      <div id="notices">
        ...
        <b>NAMA BANK : FRISKY FIRDAYANTO (BCA)</b> <br>
        <b>CABANG BANK : KUDUS</b> <br>
        <b>NOMOR AKUN BANK 031-254-7714</b> <br><br>
        <b>NAMA BANK : FRISKY FIRDAYANTO (BRI)</b> <br>
        <b>CABANG BANK : KUDUS</b> <br>
        <b>NOMOR AKUN BANK 3084-0103-4254-539</b> <br>
      </div>
      </div>
    </main>
    <footer>
