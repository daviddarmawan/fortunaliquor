                    ...
                    <tbody>
                        @foreach($order as $key => $order)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{route('debit.edit', $order)}}" class="btn btn-primary"><i
                                ...
                                <td><a href="konfirmasi_belumterkirim/{{ $order->id }}" class="btn btn-warning"
                                        onclick="return confirm('Anda yakin ubah status menjadi belum terkirim ?');">
